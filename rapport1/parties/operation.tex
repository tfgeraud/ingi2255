...
\subsection{recordAccurateAmbulancePosition}
	...
	\begin{table}[!h] \centering
		\begin{tabularx}{\textwidth}{|l|X|} \hline
			...
			État atteint & AmbulancePositionAccurate and AmbulancePositionKnown \\ \hline % EL est-ce qu'il y a vraiment un changement d etat du a cette operation? Les etats mentionnes n'apparaissent dans aucun modele d etat.
