...
\subsection{Seconde couche}
	...
	\begin{equation*}
		\begin{array}{rcl}
			...
			& = & \exists a:AmbulanceInfo, a.id = b.id  \\ % EL b sort de où?
			&   & \wedge a.choice = 1 \\
			&   & \wedge \#i.choice = 1 \\
			...
			&   & m.ambulance = a \wedge m.incident = 1 \\ % EL #m.incident = 1 ou m.incident = i? De plus, il n'existe aucune association ou attributs dans le modèle objet entre m et incident
...
\subsection{Troisième couche}
	...
	\begin{equation*}
		\begin{array}{rcl}
		% EL ambulance ne possède aucun champ id
