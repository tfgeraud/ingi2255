...
\chapter{Architecture logique}
	\section{Architectures Ã©valuÃ©es }
		\input{parties/pipe-style.tex}
	\section{Architecture finale}

\chapter{Architecture physique}

<<<<<<< HEAD:rapport3/rapport3.tex
\chapter{Ã‰vÃ¨nements Ã  l'interface}
	\input{parties/messages.tex}

\chapter{Plan de dÃ©veloppement}
	\input{parties/plan.tex}

\chapter{SpÃ©cifications externes des modules}
